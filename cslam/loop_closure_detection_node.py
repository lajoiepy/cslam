...
class LoopClosureDetection(Node):
    ...
    def __init__(self):
        ...
        self.params["enable_neighbor_monitoring"] = self.get_parameter(
            'enable_neighbor_monitoring').value
        self.params["max_heartbeat_delay_sec"] = self.get_parameter(
            'max_heartbeat_delay_sec').value
        self.params["heartbeat_period_sec"] = self.get_parameter(
            'heartbeat_period_sec').value
        self.params[
            "global_descriptor_publication_period_sec"] = self.get_parameter(
                'global_descriptor_publication_period_sec').value
        self.params[
