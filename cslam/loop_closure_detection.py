...
class LoopClosureDetection(Node):
    ...
    def __init__(self):
        ...
        params = {}
        params['similarity_threshold'] = self.get_parameter(
        ...
        params['global_descriptor_technique'] = self.get_parameter(
        ...
        params["image_crop_size"] = self.get_parameter('image_crop_size').value
