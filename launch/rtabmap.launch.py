    ...
    return [
        ...
        Node(package='cslam',
             ...
             parameters=[{
                 ...
                 "min_inbetween_keyframes":
                 LaunchConfiguration('lcd_min_inbetween_keyframes'),
                 "nb_best_matches":
                 LaunchConfiguration('lcd_nb_best_matches'),
                 "checkpoint":
                 LaunchConfiguration('lcd_checkpoint'),
                 "pca":
                 LaunchConfiguration('lcd_pca'),
                 "crop_size":
                 LaunchConfiguration('lcd_crop_size'),
                 "technique":
                 LaunchConfiguration('lcd_technique'),
                 "global_descriptor_topic":
                 LaunchConfiguration('lcd_global_descriptor_topic'),
                 "robot_id":
                 LaunchConfiguration('lcd_robot_id'),
                 "resume":
        ...
        Node(package='cslam',
             ...
             parameters=[{
                 ...
                 "consider_other_matches":
                 LaunchConfiguration('lcd_consider_other_matches'),
                 "min_inbetween_keyframes":
                 LaunchConfiguration('lcd_min_inbetween_keyframes'),
                 "add_link_srv":
                 [LaunchConfiguration('namespace'), '/add_link'],
                 "rtabmap_info_topic":
                 [LaunchConfiguration('namespace'), '/info'],
                 "rtabmap_map_topic":
                 [LaunchConfiguration('namespace'), '/mapData'],
                 "max_queue_size":
                 LaunchConfiguration('lcd_max_queue_size'),
                 "number_of_robots":
                 LaunchConfiguration('lcd_number_of_robots'),
                 "robot_id":
                 LaunchConfiguration('lcd_robot_id')
             }],
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'lcd_checkpoint',
            default_value=
            '/home/lajoiepy/Documents/projects/SelfSupervisedPlaceRecognition/pytorch-NetVlad/runs/Nov24_23-21-16_vgg16_netvlad-Pit-Baseline/checkpoints/model_best.pth.tar'
        ),
        DeclareLaunchArgument(
            'lcd_pca',
            default_value=
            '/home/lajoiepy/Documents/projects/SelfSupervisedPlaceRecognition/pytorch-NetVlad/pca.pkl'
        ),
        DeclareLaunchArgument('lcd_consider_other_matches',
                              default_value='false'),
        DeclareLaunchArgument('lcd_min_inbetween_keyframes',
                              default_value='20'),
        ...
        DeclareLaunchArgument('lcd_global_descriptor_topic',
                              default_value='/global_descriptor'),
