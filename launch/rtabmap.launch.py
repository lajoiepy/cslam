...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        Node(
            package='external_loop_closure_detection', executable='loop_closure_detection.py', name='loop_closure_detection',
            parameters=[{
                "threshold": LaunchConfiguration('lcd_threshold'),
                "min_inbetween_keyframes": LaunchConfiguration('lcd_min_inbetween_keyframes'),
                "nb_best_matches": LaunchConfiguration('lcd_nb_best_matches'),
                "checkpoint": LaunchConfiguration('lcd_checkpoint'),
        ...
        Node(
            package='external_loop_closure_detection', executable='external_loop_closure_detection', name='external_loop_closure_detection',
            parameters=[{
        ...
        Node(
            ...
            parameters=[{
                ...
                "Rtabmap/LoopThr": "1000.0",
                "Rtabmap/LoopRatio": "1000.0",
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('rgb_topic',           default_value=[LaunchConfiguration('namespace'),'/camera/rgb/image_rect_color'],       description=''),
        DeclareLaunchArgument('depth_topic',         default_value=[LaunchConfiguration('namespace'),'/camera/depth_registered/image_raw'], description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value=[LaunchConfiguration('namespace'),'/camera/rgb/camera_info'],            description=''),
