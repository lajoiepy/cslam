...
gtsam::Values::shared_ptr values_msg_to_gtsam(const std::vector<cslam_common_interfaces::msg::PoseGraphValue>& msg){
    ...
    for (auto v : msg){
        ...
        gtsam::LabeledSymbol symbol(GRAPH_LABEL, ROBOT_LABEL(v.key.robot_id), v.key.keyframe_id);
...
gtsam::NonlinearFactorGraph::shared_ptr edges_msg_to_gtsam(const std::vector<cslam_common_interfaces::msg::PoseGraphEdge>& msg){
    ...
    for (auto e: msg){
        ...
        gtsam::LabeledSymbol symbol_from(GRAPH_LABEL, ROBOT_LABEL(e.key_from.robot_id), e.key_from.keyframe_id);
        gtsam::LabeledSymbol symbol_to(GRAPH_LABEL, ROBOT_LABEL(e.key_to.robot_id), e.key_to.keyframe_id);
